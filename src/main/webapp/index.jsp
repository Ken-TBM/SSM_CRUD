...
<head>
    ...
    以/开始的相对路径，找资源，以服务器的路径为标准（http://localhost:3306）;需要加上项目名
            http://localhost:3306/03_SSM
    --%>
    <%--引入jquery--%>
    <script type="text/javascript" src="webjars/jqurey/3.1.1/jquery.js"></script>
    <%--引入样式--%>
...
<script type="text/javascript">
    ...
    function build_page_info(result){
        ...
        $("#page_info_area").append(" 当前"+result.extend.pageInfo.pageNum+"页，总"
            +result.extend.pageInfo.pages+"共页，总"
    ...
    $("#empName_add_input").change(function(){
        //判断之前的ajax用户名校验是否成功，如果成功了才往下继续走
        //发送ajax请求校验用户名是否可用
    ...
    $("#check_all").click(function () {
        ...
        //我们这些dom原生的属性用prop;attr获取自定义的属性值
        //prop修改和读取dom原生属性的值
